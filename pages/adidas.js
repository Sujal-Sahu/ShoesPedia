...
const adidas = ({user,logout,addcart,removecart,clearcart,cart,subtotal,products,colors,sizes}) => {
  ...
  return (
    <>  
     <Head>
      ...
      <Navbar user={user} logout={logout} heading="Adidas"/>
      ...
      <Link href={`/product/${products[k].slug}`}><a>
        ...
        <div className="mt-1 p-2">
          ...
          <div className="mt-3 flex items-end">
              ...
              {products[k].size.map((c)=>{return <span className='mx-2'>{c}</span>})}
          </div>
          <div className="mt-3 flex items-center">
              <h2 className='mx-3'>Color : </h2>
              {products[k].color.map((c)=>{return <span className={`mx-2 ${styles.circle}`} style={{backgroundColor:c}}></span>})}
          </div>
        </div>
        </a></Link>
    </article>})}
