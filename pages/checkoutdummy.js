...
theme="light"
/>
<div className="h-screen grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
  <div className="lg:col-span-2 bg-indigo-50 space-y-8 px-12">
    <div className="mt-8 p-4 relative flex flex-col sm:flex-row sm:items-center bg-white shadow rounded-md">
      <div className="flex flex-row items-center border-b sm:border-b-0 w-full sm:w-auto sm:pb-0">
      ...
      <div className="text-sm tracking-wide text-gray-500 sm:mt-0 sm:ml-4">Complete your shipping and payment details below.</div>
