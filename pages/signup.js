                    ...
                    <section>
                        ...
                        <fieldset class="mb-3 bg-white shadow-lg rounded text-gray-600">
                            ...
                            <label class="inline-flex border-b border-gray-200 h-12 py-3 items-center w-1/2">
                                ...
                                <input name="email" type="email" class="focus:outline-none px-3" placeholder="try@example.com" value={email} onChange={(event)=>{event.preventDefault();setemail(event.target.value)}} required=""/>
                            </label>
                            <label class="flex border-b border-gray-200 h-12 py-3 items-center">
                            ...
                            <label class="flex border-t border-gray-200 h-12 py-3 items-center">
                                ...
                                <input name="postal_code" class="focus:outline-none px-3" placeholder="123456" value={password} onChange={(event)=>{event.preventDefault();setpassword(event.target.value)}}/>
                            </label>
                        </fieldset>
                    </section>
                </form>
